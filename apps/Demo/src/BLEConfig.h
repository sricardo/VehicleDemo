...
// BLE Characteristics available in write by the central, on the MOBILE_TO_DEVICE_BLE_SERVICE   
...
// BLE Characteristics available in read only or notify by the central, on the DEVICE_TO_MOBILE_BLE_SERVICE
