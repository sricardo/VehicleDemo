...
//Characteristics available in write and read, base on the  DEVICE_TO_MOBILE_BLE_SERVICE   
...
//Characteristics available in read only, base on the MOBILE_TO_DEVICE_BLE_SERVICE
